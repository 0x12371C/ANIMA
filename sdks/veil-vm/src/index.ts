...
export type {
  ...
  SubmitBatchProofResult,
  SubmitBatchProofResponse,
  SetProofConfigRequest,
  SetProofConfigResult,
  SetProofConfigResponse,
  SetRevealCommitteeRequest,
  SetRevealCommitteeResult,
  SetRevealCommitteeResponse,
  // Identity
  ZeroIdProof,
  TrustLevel,
  Identity,
